...
import type { DecodedAmountToUiAmountInstruction } from '../../../src/instructions/amountToUiAmount.js';
import type { DecodedApproveInstruction } from '../../../src/instructions/approve.js';
import type { DecodedApproveCheckedInstruction } from '../../../src/instructions/approveChecked.js';
import type { DecodedBurnInstruction } from '../../../src/instructions/burn.js';
import type { DecodedBurnCheckedInstruction } from '../../../src/instructions/burnChecked.js';
import type { DecodedCloseAccountInstruction } from '../../../src/instructions/closeAccount.js';
import type { DecodedFreezeAccountInstruction } from '../../../src/instructions/freezeAccount.js';
import type { DecodedInitializeAccountInstruction } from '../../../src/instructions/initializeAccount.js';
import type { DecodedInitializeAccount2Instruction } from '../../../src/instructions/initializeAccount2.js';
import type { DecodedInitializeAccount3Instruction } from '../../../src/instructions/initializeAccount3.js';
import type { DecodedInitializeMintInstruction } from '../../../src/instructions/initializeMint.js';
import type { DecodedInitializeMint2Instruction } from '../../../src/instructions/initializeMint2.js';
import type { DecodedInitializeMultisigInstruction } from '../../../src/instructions/initializeMultisig.js';
import type { DecodedMintToInstruction } from '../../../src/instructions/mintTo.js';
import type { DecodedMintToCheckedInstruction } from '../../../src/instructions/mintToChecked.js';
import type { DecodedRevokeInstruction } from '../../../src/instructions/revoke.js';
import type { DecodedSetAuthorityInstruction } from '../../../src/instructions/setAuthority.js';
import type { DecodedSyncNativeInstruction } from '../../../src/instructions/syncNative.js';
import type { DecodedThawAccountInstruction } from '../../../src/instructions/thawAccount.js';
import type { DecodedTransferInstruction } from '../../../src/instructions/transfer.js';
import type { DecodedTransferCheckedInstruction } from '../../../src/instructions/transferChecked.js';
import type { DecodedUiAmountToAmountInstruction } from '../../../src/instructions/uiAmountToAmount.js';
/** TODO: docs */
